...
## Hard Gate
- Do NOT fix security issues yourself during review.
- Your output is a security report with findings and recommendations.
- The dev decides what to fix and when.
